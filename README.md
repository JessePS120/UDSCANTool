...
The purpose of this project is to create a client device that can send UDS requests via a terminal. For more detailed information, see Docs/PROJECTREQUIREMENTS.md. To see the status 
